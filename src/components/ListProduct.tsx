      ...
      <div className='py-6 flex flex-col gap-5 px-4'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-1'>
            <MdOutlineStarPurple500 className='text-lg text-cumbiaYellow' />{' '}
        ...
        <div className='flex items-center gap-5 duration-300'>
          ...
          <Link
            ...
            className='bg-gray-800 text-gray-200 px-4 py-2 text-xs rounded-full flex items-center gap-1 hover:bg-gray-950 hover:bg-amber-100 duration-200'
          >
